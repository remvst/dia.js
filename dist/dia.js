...
dia.wireframes.BUTTON.setRepresentationFactory(function(element, representation){
	...
	representation.addRenderable(new dia.Renderable(function(c){
		...
		c.fillStyle = '#000';
		c.fillRect(2, 2, element.getProperty('width'), element.getProperty('height'));
...
dia.wireframes.LABEL = new dia.ElementType({
	id: 'wireframes.LABEL',
	label: 'Label',
	layer: 3
});
dia.wireframes.LABEL.addProperty(new dia.Property({
	id: 'x',
	type: dia.DataType.INTEGER,
	default: 0,
	private: true
...
dia.wireframes.LABEL.setRepresentationFactory(function(element, representation){
	var lineHeight = 16;
	var padding = 5;
...
dia.wireframes.LABEL.addTool(new dia.CreateTool({
	type: dia.wireframes.LABEL,
	mouseDown: function(sheet, x, y){
		var element = this.type.emptyElement();
		element.setProperty('x', ~~x);
		element.setProperty('y', ~~y);
